...
class AgentExecutor:
    ...
    async def execute(self, agent_id: str, task: Dict[str, Any], handler: Callable) -> str:
        ...
        # Return execution_id immediately after scheduling, don't wait for completion
        # This lets clients cancel or monitor active work
        asyncio.create_task(self._track_execution(execution_id, task_obj))
        return execution_id

    async def _track_execution(self, execution_id: str, task_obj: asyncio.Task) -> None:
        try:
