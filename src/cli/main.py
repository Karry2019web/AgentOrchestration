...
def non_negative_int(value: str) -> int:
    ...
    if n < 0:
        raise argparse.ArgumentTypeError(f"'{value}' is not a valid value (must be >= 0)")
    return n
...
def cli():
    ...
    logs_parser.add_argument("--tail", "-t", type=non_negative_int, default=50, help="Number of lines")
