...
class Config:
    ...
    def load(self, path: str) -> None:
        with open(path) as f:
            self._data = self._deepcopy_value(json.load(f))
    ...
    def _set_nested(self, key: str, value: Any) -> None:
        ...
        current[parts[-1]] = self._deepcopy_value(value)
    ...
    def get(self, key: str, default: Any = None) -> Any:
        ...
        for part in parts:
            if isinstance(current, dict):
                ...
                return default
        return self._deepcopy_value(current)

    def set(self, key: str, value: Any) -> None:
        self._set_nested(key, value)

    def to_dict(self) -> Dict:
        return self._deepcopy_value(self._data)
